...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['label_matches'] = 0
    # Number of images
    ...
    # Objective _2: Percentage of Correctly Classified Dog Breed
    ...
    results_stats_dic['pct_label_matches'] = 100 * results_stats_dic['n_match']/results_stats_dic['n_images']
